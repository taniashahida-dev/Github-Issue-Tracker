...
issueCount.innerText = allIssue.length + " Issues"
  allIssue.forEach((cards) =>{
    ...
    card.className = ` max-w-sm bg-white rounded-xl shadow-md p-5 border-t-4 ${cards.priority === "high" || cards.priority === "medium" ? "border-green-500" : "border-purple-500"}
        `;

    card.innerHTML = `
  <div class="flex justify-between items-center mb-4">
    <div class="w-10 h-10 flex items-center justify-center rounded-full  ${cards.priority === "low" ? "bg-red-100": "bg-green-100" }">
    ${cards.priority === "high" || cards.priority === "medium" ? '<img class="w-8" src="./assets/Open-Status.png" alt="open">':'<img src="./assets/Closed- Status .png" alt="">'}
